...
#define FN_CAST_SPELL			   0x5C90A0 // 9.9 || E8 ? ? ? ? 8B 7C 24 10 5D
#define FN_DRAW_CIRCLE			   0x5D69A0 // 9.9 || E8 ? ? ? ? 83 C4 1C 8B 44 24 18 
#define FN_GET_ATTACK_CAST_DELAY   0x5E3670 // 9.9 || E8 ? ? ? ? D9 9E ? ? ? ? 57
#define FN_GET_ATTACK_DELAY		   0x5E3750 // 9.9 || E8 ? ? ? ? 8B 44 24 30 83 C4 0C 8B CE 66
#define FN_GET_SPELL_STATE         0x5C06E0 // 9.9 || E8 ? ? ? ? 8B F0 8B 0E 85 C9 74 03 FF 41 18 8B 4F 7C || 57 8B 7C 24 0C 83 7F 04
#define FN_ISSUE_ORDER			   0x1C0790 // 9.9 || E8 ? ? ? ? 8B 84 24 ? ? ? ? 8B CF F3
#define FN_IS_ALIVE				   0x1E4B30 // 9.9 || E8 ? ? ? ? 84 C0 74 3B 8B
#define FN_IS_HERO				   0x2277D0 // 9.9 || E8 ? ? ? ? 84 C0 C7 44 24 ? ? ? ? ? 8D 44 24 30
#define FN_IS_MINION			   0x227810 // 9.9 || E8 ? ? ? ? 83 C4 04 84 C0 74 16 8B 0F
#define FN_IS_MISSILE			   0x227830 // 9.9 || E8 ? ? ? ? 83 C4 04 84 C0 74 1C FF
#define FN_IS_TARGETABLE		   0x220870 // 9.9 || E8 ? ? ? ? 84 C0 74 2E 68 ? ? ? ? 8B 
#define FN_IS_TROY				   0x227AB0 // 9.9 || E8 ? ? ? ? 8B F8 83 C4 04 85 FF 0F 84 ? ? ? ? 39 
#define FN_IS_TURRET			   0x2279C0 // 9.9 || E8 ? ? ? ? 83 C4 04 84 C0 74 10 32
#define FN_UPDATE_CHARGEABLE_SPELL 0x5A0470 // 9.9 || E8 ? ? ? ? 5E 5F B0 01 5B 83 C4 10
#define FN_WORLD_TO_SCREEN		   0x81CA70 // 9.9 || E8 ? ? ? ? F3 0F 10 44 24 ? 83 C4 10 F3 0F 5C

#define CHAT_CLIENT				0x16DA510 // 9.9 || 8B 0D ? ? ? ? 6A 00 50 E8 ? ? ? ? 33
#define GAME_TIME				0x2F77A90 // 9.9 || F3 0F 5C 0D ? ? ? ? 0F 2F C1 F3
#define HUD_INSTANCE			0x16DCCF0 // 9.9 || A1 ? ? ? ? F3 0F 10 44 24 ? F3 0F 11 
#define LOCAL_PLAYER			0x2F7D224 // 9.9 || A1 ? ? ? ? 85 C0 0F 84 ? ? ? ? 56 8B B0
#define OBJECT_MANAGER			0x169CA00 // 9.9 || B9 ? ? ? ? E8 ? ? ? ? 8B C8 8B 10 8B 82
#define OBJECT_UNDER_MOUSE		0x232D4CC // 9.9 || C7 05 ? ? ? ? ? ? ? ? E8 ? ? ? ? 83 C4 04 FF B4
#define RENDERER				0x2F9AE50 // 9.9 || 8B 15 ? ? ? ? 83 EC 08 F3
#define ZOOM_CLASS				0x2F96778 // 9.9 || B9 ? ? ? ? 89 84 24 ? ? ? ? 8D 44 
...
#define O_NETWORK_ID		0xB8	// 272
#define O_POS				0x1A0	// 412
#define O_RECALL_NAME		0xDA4	// 3512
#define O_RECALL_STATE		0xDA4	// 3528
#define O_MANA				0x03F8	// 1016
#define O_MAX_MANA			0x0408	// 1032
#define O_HEALTH			0x0DE8	// 3560
#define O_MAX_HEALTH		0x0DF8	// 3576
#define O_BONUS_AD			0x11C0	// 4576
#define O_BONUS_AP			0x11D0	// 4592
#define O_BASE_AD			0x1240	// 4704
#define O_BASE_AP			0x1450	// 4704
#define O_CRIT_RATE			0x1264  // 4740
#define O_ARMOR				0x1270	// 4744
#define O_MAGIC_RESIST		0x1290	// 4752
#define O_BONUS_MR   		0x1274	// 4752
#define O_MOVE_SPEED		0x1280	// 4768
#define O_ATTACK_RANGE		0x1288	// 4776
#define O_BUFF_MGR			0x20D8	// 8432
#define O_SPELLBOOK			0x2890	// 10480
#define O_ACTOR_NAME		0x3140//0x3158	// 12632
#define O_LEVEL				0x497C	// 18788
